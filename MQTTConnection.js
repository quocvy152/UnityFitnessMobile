...
export default class MQTTConnection {
    ...
    subcribeChannel(channel) {
        console.log('MQTTConnection subcribeChannel: ', channel);
    ...
    unsubcribeChannel(channel) {
        console.log('MQTTConnection unsubcribeChannel: ', channel);
        if(!this.mqtt || !this.mqtt.isConnected()) {
            return;
        }
